      ...
      child: Column(
            ...
            child: Row(
              children: [
                CustomTextWidget(
                  ...
                  style: widget.labelStyle ?? Theme.of(context).textTheme
              ...
              children: [
                ...
                //   child:
                  CustomDropdown<dynamic>(
                    ...
                    closedHeaderPadding: widget.headerPadding ??
                        // EdgeInsets.symmetric(horizontal: 15.w, vertical: 10.h),
                        EdgeInsets.symmetric(horizontal: r.space(15), vertical: r.space(10)),
                    ...
                    disabledDecoration: CustomDropdownDisabledDecoration(
                      ...
                      hintStyle: widget.headerTextStyle ?? Theme.of(context).textTheme
        .rHint(context)!,
                      // headerStyle: widget.headerTextStyle ?? textStyle,
                      headerStyle: widget.headerTextStyle ?? Theme.of(context).textTheme
        .rBodyMedium(context)!,
                      borderRadius:
        ...
        .rHint(context)!,
                      ...
                      errorStyle: Theme.of(context).textTheme
                          .rError(context)!.copyWith(fontSize: r.font(10)),
        ...
        .rHint(context)!,
                    ...
                    hintBuilder: (context, hint, enabled) {
                      return CustomTextWidget(
                        ...
                        style: widget.headerTextStyle ?? Theme.of(context).textTheme
                            .rHint(context)!,
                      );
                    },
                    listItemBuilder: (context, item, isSelected, onItemSelect) {
                      ...
                      return CustomTextWidget(
                        ...
                        style: widget.isColored &&
                            ...
                            .rBodyMedium(context)!.copyWith(fontSize: r.font(12))
                        // textStyle.copyWith(
                    ...
                    headerBuilder: (context, item, isSelected) {
                      return CustomTextWidget(
                        ...
                        //     : widget.headerTextStyle ?? textStyle,
                            : widget.headerTextStyle ?? Theme.of(context).textTheme
                            .rBodyMedium(context)!.copyWith(fontSize: r.font(12)),
                      );
                    },
                    onChanged: (value) {
                ...
                widget.showError && widget.error != null
                  ...
                  padding: EdgeInsets.symmetric(
                      ...
                      horizontal: r.px(4), vertical: r.px(4)),
                  child:
                  // CustomTextWidget(widget.error!, style: errorStyle),
                  CustomTextWidget(widget.error!, style: Theme.of(context).textTheme
                      .rError(context)!),
                )
                    : const SizedBox.shrink()
              ],
